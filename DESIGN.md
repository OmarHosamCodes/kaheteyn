...
colors:
  olive-guardian:
    value: "oklch(0.62 0.18 145)"
    role: primary
  ember-authority:
    value: "oklch(0.6 0.22 27)"
    role: destructive
  ink-foundation:
    value: "oklch(0.18 0 0)"
    role: neutral-text
  parchment-surface:
  ...
  jade-lantern:
    ...
    role: dark-primary
  coral-signal:
    value: "oklch(0.7 0.19 22)"
    role: dark-destructive
typography:
  body:
    fontFamily: "Tajawal, Inter Variable, system-ui, sans-serif"
    fontWeight: 400
    lineHeight: "1.6"
  label:
    fontFamily: "Tajawal, Inter Variable, system-ui, sans-serif"
...
components:
  button-primary:
    backgroundColor: "{colors.olive-guardian}"
    textColor: "{colors.parchment-surface}"
    rounded: "{rounded.none}"
    padding: "0 10px"
    height: "32px"
  button-primary-hover:
    backgroundColor: "oklch(0.62 0.18 145 / 80%)"
  button-outline:
    backgroundColor: "{colors.parchment-surface}"
    textColor: "{colors.ink-foundation}"
    rounded: "{rounded.none}"
    border: "1px solid {colors.stone-border}"
    padding: "0 10px"
    height: "32px"
  button-destructive:
    backgroundColor: "oklch(0.6 0.22 27 / 10%)"
    textColor: "{colors.ember-authority}"
    rounded: "{rounded.none}"
    padding: "0 10px"
    height: "32px"
  input-field:
  ...
  card-surface:
    backgroundColor: "{colors.bone-page}"
    rounded: "{rounded.none}"
    border: "1px solid oklch(0.18 0 0 / 10%)"
    padding: "16px"
  sidebar-nav:
    backgroundColor: "{colors.parchment-surface}"
    textColor: "{colors.ink-foundation}"
